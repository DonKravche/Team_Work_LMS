    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('students', models.ManyToManyField(blank=True, related_name='attendances', to=settings.AUTH_USER_MODEL, verbose_name='Students')),
                ('subject', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='attendances', to='student.subject', verbose_name='Subject')),
            ],
        ),
        migrations.CreateModel(
            name='Task',
            fields=[
                ...
                ('execution_date', models.DateField(verbose_name='Execution Date')),
                ('lecturer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tasks', to=settings.AUTH_USER_MODEL, verbose_name='Lecturer')),
            ],
        ),
        migrations.CreateModel(
            name='Assignment',
            fields=[
                ...
                ('attached_file', models.FileField(upload_to='assignments/', verbose_name='Attached File')),
                ...
                ('task', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='assignments', to='student.task', verbose_name='Task')),
            ],
        ),
    ]
